...
if(TRUE)
  set(opencv_tests_SOURCE_PREFIX /home/viki/WurzelWorkspace/src/image_geometry/opencv_tests)
  set(opencv_tests_DEVEL_PREFIX /home/viki/WurzelWorkspace/devel)
  ...
  set(opencv_tests_INSTALL_PREFIX /home/viki/WurzelWorkspace/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir )
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/viki/WurzelWorkspace/src/image_geometry/opencv_tests/${idir})
      set(include /home/viki/WurzelWorkspace/src/image_geometry/opencv_tests/${idir})
    else()
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viki/WurzelWorkspace/src/image_geometry/opencv_tests/${idir}'.  Ask the maintainer '${opencv_tests_MAINTAINER}' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND opencv_tests_LIBRARIES ${${opencv_tests_dep}_LIBRARIES})
  _list_append_unique(opencv_tests_LIBRARY_DIRS ${${opencv_tests_dep}_LIBRARY_DIRS})
endforeach()

if(opencv_tests_LIBRARIES)
  _remove_duplicate_libraries(opencv_tests_LIBRARIES opencv_tests_LIBRARIES)
endif()
