...
if(TRUE)
  set(image_geometry_SOURCE_PREFIX /home/viki/WurzelWorkspace/src/image_geometry/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/viki/WurzelWorkspace/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/viki/WurzelWorkspace/install)
...
if(NOT "/home/viki/WurzelWorkspace/src/image_geometry/image_geometry/include;/opt/ros/groovy/include/opencv;/opt/ros/groovy/include" STREQUAL "")
  set(image_geometry_INCLUDE_DIRS "")
  foreach(idir /home/viki/WurzelWorkspace/src/image_geometry/image_geometry/include;/opt/ros/groovy/include/opencv;/opt/ros/groovy/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/viki/WurzelWorkspace/src/image_geometry/image_geometry/${idir})
      set(include /home/viki/WurzelWorkspace/src/image_geometry/image_geometry/${idir})
    else()
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viki/WurzelWorkspace/src/image_geometry/image_geometry/${idir}'.  Ask the maintainer '${image_geometry_MAINTAINER}' to fix it.")
    endif()
