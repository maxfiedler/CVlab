...
if(NOT "" STREQUAL "")
  ...
  foreach(idir )
    ...
    elseif(IS_DIRECTORY /home/viki/WurzelWorkspace/install/${idir})
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viki/WurzelWorkspace/install/${idir}'.  Ask the maintainer '${opencv_tests_MAINTAINER}' to fix it.")
    endif()
